...
* [关于mysql的几件小事](mysql)
	* [(一)关于MySQL索引的几件小事](mysql/关于MySQL索引的几件小事.md)
	* [(二)关于mysql事务的几件小事](mysql/关于mysql事务的几件小事.md)

	* [(三)数据库如何拆分](mysql/分库分布的几件小事（一）数据库如何拆分.md)
	
	* [(四)如何进行分库分表的数据迁移](mysql/分库分布的几件小事（二）如何进行分库分表的数据迁移.md)
	
	* [(五)可以动态扩容缩容的分库分表方案](mysql/分库分布的几件小事（三）可以动态扩容缩容的分库分表方案.md)
	
	* [(六)分库分表的id主键生成](mysql/分库分布的几件小事（四）分库分表的id主键生成.md)
...
* [关于SpringBoot的几件小事](springboot)
	* [(一)关于SpringBoot的自动配置去启动过程](springboot/关于SpringBoot的自动配置去启动过程.md)		
